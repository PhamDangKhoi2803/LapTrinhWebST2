...
<form action = "<c:url value = "/admin/category/update"/>" method ="post">
	...
	<input type="text" id="catagoryname" name="categoryname" value = "${cate.categoryname }"><br>
	...
	<c:if test="${cate.images.substring(0,5)=='https'}">
				...
				</c:if> <img height="150" width="200" src="${imgUrl}" /><br>
	
	<input type="file" id="images" name="images" value = "${cate.images }"><br>
	<label for="status">Status:</label><br> 
	<input type="text" id="status" name="status" value = "${cate.status }">
