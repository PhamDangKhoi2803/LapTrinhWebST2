	...
	<form action="/Ltweb/forgot" method="post">
		...
		<div class="container">
			<label for="username"><input type="text"
				...
				for="email"> <input type="text" placeholder="Email"
				name="email" required></label> <label for="phone"> <input
				type="text" placeholder="Phone" name="phone" required></label> <label
				for="password"> <input type="password"
				placeholder="Password" name="password" required></label> <label
				for="repassword"> <input type="password"
